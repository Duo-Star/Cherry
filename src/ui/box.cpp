...
Box::Box()
    : _x(0), _y(0), _w(1.0f), _h(1.0f), _abs_x0(0), _abs_y0(0), _abs_x1(0), _abs_y1(0), _bg(0), _has_bg(false), _visible(true), _parent(nullptr), _first_child(nullptr), _next(nullptr)
{
}

Box::Box(BoxCoord x, BoxCoord y, BoxCoord w, BoxCoord h)
    : _x(x), _y(y), _w(w), _h(h), _abs_x0(0), _abs_y0(0), _abs_x1(0), _abs_y1(0), _bg(0), _has_bg(false), _visible(true), _parent(nullptr), _first_child(nullptr), _next(nullptr)
{
}
...
void Box::set_pos(BoxCoord x, BoxCoord y)
{
    _x = x;
    _y = y;
}
void Box::set_size(BoxCoord w, BoxCoord h)
{
    _w = w;
    _h = h;
}
                 ...
                 int16_t parent_x1, int16_t parent_y1)
{
    ...
    if (_abs_x0 < parent_x0)
        _abs_x0 = parent_x0;
    if (_abs_y0 < parent_y0)
        _abs_y0 = parent_y0;
    if (_abs_x1 > parent_x1)
        _abs_x1 = parent_x1;
    if (_abs_y1 > parent_y1)
        _abs_y1 = parent_y1;
